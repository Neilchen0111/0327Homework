...
// Parse-SDK-Helpers
#define COCOAPODS_POD_AVAILABLE_Parse_SDK_Helpers
#define COCOAPODS_VERSION_MAJOR_Parse_SDK_Helpers 1
#define COCOAPODS_VERSION_MINOR_Parse_SDK_Helpers 1
#define COCOAPODS_VERSION_PATCH_Parse_SDK_Helpers 0

// Parse-SDK-Helpers/Core
#define COCOAPODS_POD_AVAILABLE_Parse_SDK_Helpers_Core
#define COCOAPODS_VERSION_MAJOR_Parse_SDK_Helpers_Core 1
#define COCOAPODS_VERSION_MINOR_Parse_SDK_Helpers_Core 1
#define COCOAPODS_VERSION_PATCH_Parse_SDK_Helpers_Core 0
